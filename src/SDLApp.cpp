...
// Constructor
SDLApp::SDLApp(const char* title,int x, int y, int w, int h) : m_width(w), m_height(h), m_maxFrameRate(60), m_mouseX(0), m_mouseY(0), m_FPS(0)
{
...
void SDLApp::RunLoop(){
    while(m_gameIsRunning){
        ...
        m_FPS = 1000 / (m_maxFrameRate > 0? m_maxFrameRate : elapsedTime > 0 ? elapsedTime : 1);
